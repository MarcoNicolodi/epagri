    ...
    <div class="col-md-12">
        <div class="panel panel-green">
            <div class="panel-heading">
                <h3 class="panel-title"> Novo Usuário </h2>
            </div>
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <?= $this->Form->input('cidade_id', ['options' => [null => "Selecione um estado"], 'class' => 'form-control']); ?>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <?= $this->Form->button('Cadastrar',['class' => 'btn btn-primary btn-lg']) ?>
                </div>
                <?= $this->Form->end() ?>
            </div>
        </div>
