...
/**
 * EntradaProdutosFixture
 *
 */
class EntradaProdutosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_entrada_produto_produto1_idx' => ['type' => 'index', 'columns' => ['produto_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_entrada_produto_produto1' => ['type' => 'foreign', 'columns' => ['produto_id'], 'references' => ['produtos', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
